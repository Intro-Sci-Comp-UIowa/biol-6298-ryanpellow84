...
* Download the Hi-C data from NCBI GEO-Accession: GSE97965 (has been located)
* Hi-C data will be processed with HiCExplorer and HiCBrowser (both available on github)
    * Does mapping, stats and plotting
* Download the ChIP-seq data from NCBI GEO-Accession: multiple (has been located)
* Aligned to dm3: Bowtie2
* Identify peaks for proteins: MACS2
* Identify motifs: MEME-chip
    * Various stats done throughout, depending on step
    * Data sent to HiCExplorer to be plotted
